...
$csvFilePath = "C:\Users\ext.goutham.gummadi\EDHC\Technology - Infrastructure\PhyscialAccessAudit\AD Active Users\UsersList_$CurrentDate.csv"
$csvFilePath1 = "C:\Users\ext.goutham.gummadi\EDHC\Technology - Infrastructure\AD data match with ADP\AD current users list\UsersList_$CurrentDate.csv"
